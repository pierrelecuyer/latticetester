 ...
 * upper-left corner of the basis matrix.  One can then reuse the same block of memory
 * for millions of lattices even if their bases have different dimensions.
 * It is also possible to recover an array `sqlen` that gives the square
 * Euclidean lengths of the basis vectors.
 * These lengths are maintained in a `RealVec` object.
...
// NTL_OPEN_NNS
/**
 * \namespace NTL  We put these functions in the NTL namespace.
 */
namespace NTL {
