...
FromRanges::FromRanges(Coordinates::size_type minOrder, Coordinates::size_type maxOrder,
      Coordinates::value_type minCoord, Coordinates::value_type maxCoord, const bool includeFirst) {
...
void FromRanges::includeOrder(Coordinates::size_type order, Coordinates::value_type minCoord,
...
void FromRanges::excludeOrder(Coordinates::size_type order) {
   ...
   if (it != m_ranges.end()) m_ranges.erase(it);
}
...
Subsets::Subsets(const Coordinates &coords, Coordinates::size_type minOrder,
